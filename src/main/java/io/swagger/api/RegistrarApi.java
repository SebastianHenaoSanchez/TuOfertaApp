...
public interface RegistrarApi {
    ...
    @ApiOperation(value = "registro de personas", nickname = "registrarPost", notes = "registro de personas (clientes y administrador)", response = JsonApiBodyResponseSuccess.class, tags={ "personas", })
    @ApiResponses(value = { 
